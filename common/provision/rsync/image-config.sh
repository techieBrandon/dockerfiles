...
apt-get update && apt-get install -y unzip wget iproute2 openssh-server supervisor rsync
...
wget -nH -e robots=off --reject "index.html*" -nv ${HTTP_PACK_SERVER}/supervisord.conf
